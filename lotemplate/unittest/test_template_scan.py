...
class Text(unittest.TestCase):
    ...
    def test_noformat(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/text_vars_noformat.odt", cnx, False)).scan())
        doc.close()
    ...
    def test_format(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/text_vars.odt", cnx, False)).scan())
        doc.close()

    def test_text_var_in_header(self):
        self.assertEqual(
            {"my_var": {"type": "text", "value": ""}},
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/text_var_in_header.odt", cnx, False)).scan()
        )
        doc.close()
    ...
    def test_static_table(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/static_tab.odt", cnx, False)).scan()
        )
        doc.close()
    ...
    def test_function_variable(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/function_variable.odt", cnx, False)).scan()
        )
        doc.close()
    ...
    def test_for_variable(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/for.odt", cnx, False)).scan()
        )
        doc.close()
...
class Images(unittest.TestCase):
    ...
    def test_one_image(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/img_vars.odt", cnx, False)).scan()
        )
        doc.close()
    ...
    def test_multiple_images(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/multiple_img_vars.odt", cnx, False)).scan()
        )
        doc.close()
...
class Tables(unittest.TestCase):
    ...
    def test_multiple_row(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/multiple_row_tab.odt", cnx, False)).scan()
        )
        doc.close()
    ...
    def test_one_row_varied(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/one_row_tab_varied.odt", cnx, False)).scan()
        )
        doc.close()
    ...
    def test_two_row_varied(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/two_row_tab_varied.odt", cnx, False)).scan()
        )
        doc.close()
    ...
    def test_two_tabs_varied(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/two_tabs_varied.odt", cnx, False)).scan()
        )
        doc.close()
    ...
    def test_function_variable(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/function_variable_tab.odt", cnx, False)).scan()
        )
        doc.close()
...
class Generic(unittest.TestCase):
    ...
    def test_multiple_variables(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/multiple_variables.odt", cnx, False)).scan())
        doc.close()
...
class OtherFormats(unittest.TestCase):
    ...
    def test_ott(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/format.ott", cnx, False)).scan()
        )
        doc.close()
    ...
    def test_docx(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/format.docx", cnx, False)).scan()
        )
        doc.close()
    ...
    def test_text(self):
        self.assertEqual(
            {"signature": {"type": "text", "value": ""}},
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/format.txt", cnx, False)).scan()
        )
        doc.close()
    ...
    def test_html(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/format.html", cnx, False)).scan()
        )
        doc.close()

    def test_html_without_endhtml(self):
        with self.assertRaises(ot.errors.TemplateError):
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/html_without_endhtml.odt", cnx, False)).scan()
            doc.close()
    ...
    def test_rtf(self):
        self.assertEqual(
            ...
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/format.rtf", cnx, False)).scan()
        )
        doc.close()

    def test_for_inside_if(self):
        doc = ot.TemplateFromExt("lotemplate/unittest/files/content/for_inside_if.odt", cnx, False)
        self.assertEqual(
            {
    ...
    def test_if_syntax_error(self):
        with self.assertRaises(ot.errors.TemplateError) as cm:
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/if_syntax_error.odt", cnx, False)).scan()
            doc.close()
        self.assertEqual(cm.exception.code, "syntax_error_in_if_statement")

    def test_for_syntax_error(self):
        with self.assertRaises(ot.errors.TemplateError) as cm:
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/for_syntax_error.odt", cnx, False)).scan()
            doc.close()
        self.assertEqual(cm.exception.code, "syntax_error_in_for_statement")

    def test_if_syntax_error_no_endif(self):
        with self.assertRaises(ot.errors.TemplateError) as cm:
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/if_syntax_error_no_endif.odt", cnx, False)).scan()
            doc.close()
        self.assertEqual(cm.exception.code, "no_endif_found")

    def test_invalid(self):
        with self.assertRaises(ot.errors.TemplateError):
            (doc := ot.TemplateFromExt("lotemplate/unittest/files/templates/invalid_format.jpg", cnx, False)).scan()
            doc.close()
